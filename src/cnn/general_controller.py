...
flags.DEFINE_integer("controller_train_steps", 50, "")
flags.DEFINE_integer("controller_forwards_limit", 2, "")
flags.DEFINE_integer("controller_train_every", 2,
               "train the controller after this number of epochs")


def _set_default_params(params):
  #params.add_hparam('child_num_layers', FLAGS.child_num_layers,'Number of blocks')
...
class GeneralController(Controller):
  def __init__(self,
               ...
               num_branches=6,
               lstm_size=64,           #origin:32
               lstm_num_layers=1,      #origin:2
               lstm_keep_prob=1.0,
               tanh_constant=1.5,
               temperature=None,
               op_tanh_reduce=2.5,
               ...
               clip_mode="norm",      #modified origin:NONE
               grad_bound=5.0,
               use_critic=False,
               bl_dec=0.99,
               optim_algo="adam",
    ...
    num_layers = params.child_num_layers
